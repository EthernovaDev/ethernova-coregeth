...
- `genesis-mainnet.json`: higher difficulty (0x400000), baseFeeVault set, chainId/networkId 121525 (genesis). Runtime chainId/networkId enforces 121525 at block 138396.
